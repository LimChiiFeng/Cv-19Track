								...
								<div class="modal-content">
									...
									<form role="form" method="post" action="test_list.php" id="editPatientForm<?php echo $pusername; ?>" name="editPatientForm" onsubmit="return updatePatientForm(this.id);">
										...
										<div class="form-group">
											...
											<textarea class="form-control" name="patientSymptoms" id="patientSymptoms" rows="5" > <?php echo $psymptoms ?> </textarea>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<form role="form" method="post" action="test_list.php" name="newTestForm" onsubmit="return recordTestForm(this);">
								...
								<div class="form-group">
                                    <label>Symptoms</label>
									<textarea class="form-control" name="symptoms" id="symptoms" rows="5" value=""></textarea>
                                    <!-- <input type="text" name="patientSymptoms" class="form-control" id="patientSymptoms"> -->
                                    <span class = "invalid-feedback" id = "symptomsErr"> *Please enter symptoms.</span>
                                </div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></small> 
    ...
    function recordTestForm(){
		...
		var symptoms=document.newTestForm.symptoms;
		...
		if(symptoms.value =="" ) {
			document.getElementById('symptomsErr').style.display = 'block';
			// return false;
			errorMsg++;
		} else {
			document.getElementById('symptomsErr').style.display = 'none';
		}
		...
		if(errorMsg != 0){
			...
			} else if(patientPassword.value == "" || !patientPassword.value.match(/^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])[0-9a-zA-Z]{8,20}$/)) {
